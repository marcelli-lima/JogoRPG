 ...
 public static void criacaoPersonagem() {
    ...
    public static String getNomePersonagem() {
        ...
        do {
            ...
            System.out.println("Seu nome é " + nome + "? Aperte 0 para confirmar.");
    ...
    public static TiposSexo getSexoPersonagem() {
        ...
        do {
            ...
            if (sexo >= TiposSexo.values().length) {
                ...
                System.out.println("O sexo do seu personagem é " + tipoSexo + "? Aperte 0 para confirmar ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
    ...
    public static TiposClasses getClassePersonagem() {
        ...
        do {
            ...
            if (classe >= TiposClasses.values().length) {
                ...
                System.out.println("A classe do seu personagem é " + tipoClasse + "? Aperte 0 para confirmar ou 1 para escolher novamente..");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
        return tipoClasse;
    ...
    public static TiposArmas getTipoArmaPersonagem(TiposClasses tipoClasse) {
        ...
        do {
            ...
            if (arma >= armasClasse.size()) {
                ...
                System.out.println("A arma do seu personagem é " + tipoArma + "? Aperte 0 para confirmar ou ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
        return tipoArma;
    ...
    private static TiposNiveis getTipoNivelJogo() {
        ...
        do {
            ...
            if (nivel >= TiposNiveis.values().length) {
                ...
                System.out.println("A dificuldade do jogo é " + tipoNivel + "? Aperte 0 para confirmar ou ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
        return tipoNivel;
    ...
    public static String getMotivacaoPersonagem() {
        ...
        do {
            ...
            if (motivacao >= TiposMotivacoes.values().length) {
                ...
                System.out.println("A motivação do seu personagem é " + tipoMotivacao + "? Aperte 0 para confirmar ou ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
    ...
    public static void opcaoSeguirDesistir() {
        ...
        do {
            ...
            if (escolha > 2 || escolha < 1) {
                ...
                System.out.println("Você vai " + acao + "? Aperte 0 para confirmar ou ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
    ...
    public static void opcaoSaltarAndarCorrer() {
        ...
        int confirmacao;
        do {
            System.out.println("   Como você vai passar pela porta?\r\n"
            		+ "                    1. SALTANDO\r\n"
            		+ "                    2. ANDANDO\r\n"
            		+ "                    3. CORRENDO");
            ...
            if (escolha > 3 || escolha < 1) {
                ...
                System.out.println("Aperte 0 para confirmar ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
    ...
    public static void primeiroInimigo() {
        ...
        do {
            ...
            if (escolha > 2) {
                ...
                System.out.println("Você vai \"" + tipoEscolha + "\"? Aperte 0 para confirmar ou 1 para escolher novamente.");
                confirmacao = confirmaEscolha();
            }
        } while (confirmacao != 0);
        if (escolha == 1) {
